...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get faqDataStorageAnswer =>
      'Твои моменты живут сначала на устройстве. Если войти в аккаунт, они также сохраняются в твоей личной резервной копии, чтобы новый телефон мог всё восстановить — включая отметки настроения и заметки. Их не видит никто, а удаление аккаунта удаляет и копию.';
  ...
  String get insightsPastEmptyBody =>
      'Здесь ничего не собралось — и это не помешало ни одному месяцу после.';

  @override
  String get faqWhatIsMoment => 'Что за квадраты?';

  @override
  String get faqWhatIsMomentAnswer =>
      'Каждое выполненное действие становится квадратом — моментом — в сетке месяца. Сетка только растёт: у пропущенного дня нет квадрата, потому что дни здесь не единица измерения. Цвет — это область фокуса, оттенок — как это отозвалось.';

  @override
  String get faqWhatAreSeasons => 'Что такое мой сезон?';

  @override
  String get faqWhatAreSeasonsAnswer =>
      'Когда в месяце набирается около десяти моментов, Intended называет его узор — Вечер, Ровное, Возвращение. Это наблюдение о месяце, а не ярлык на тебе: следующий месяц читается заново, а слово закрытого месяца заморожено навсегда.';

  @override
  String get faqPlusReads => 'Что Intended+ делает с моим месяцем?';

  @override
  String get faqPlusReadsAnswer =>
      'Читает то, что бесплатная версия показывает. Предупреждение о дрейфе замечает тихую полосу заранее, пока неделю ещё можно изменить. Письмо возвращает тебе месяц в четырёх строках и заканчивается вопросом. План превращает прошлый месяц в одно-два конкретных изменения — а через четыре недели честно говорит, сработало ли.';

  @override
  String get faqStopPaying => 'Я что-то теряю, если перестану платить?';
